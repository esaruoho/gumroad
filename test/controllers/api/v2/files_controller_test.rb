...
# Original spec: spec/controllers/api/v2/files_controller_spec.rb (deleted in this commit; see git history)
...
class Api::V2::FilesControllerTest < ActionController::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/controllers/api/v2/files_controller_spec.rb — controller spec with shared auth/Pundit contexts"
  end
end
