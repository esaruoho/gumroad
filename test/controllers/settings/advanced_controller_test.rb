...
# Original spec: spec/controllers/settings/advanced_controller_spec.rb (deleted in this commit; see git history)
...
class Settings::AdvancedControllerTest < ActionController::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/controllers/settings/advanced_controller_spec.rb — controller spec with shared auth/Pundit contexts"
  end
end
