...
# Original spec: spec/controllers/settings/team/invitations_controller_spec.rb (deleted in this commit; see git history)
# Reason: controller request-style spec with heavy auth/session/shared_context setup
# (FB/create/let/shared_context refs: 42). Requires fixture-based equivalents
...
class Settings::Team::InvitationsControllerTest < ActionController::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/controllers/settings/team/invitations_controller_spec.rb — controller spec with shared auth/Pundit contexts"
  end
end
