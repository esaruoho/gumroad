...
# Original spec: spec/controllers/bundles_controller_spec.rb (deleted in this commit; see git history)
...
class BundlesControllerTest < ActionController::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/controllers/bundles_controller_spec.rb — controller spec with shared auth/Pundit contexts"
  end
end
