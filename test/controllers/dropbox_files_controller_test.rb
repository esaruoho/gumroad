...
# Original spec: spec/controllers/dropbox_files_controller_spec.rb (deleted in this commit; see git history)
...
class DropboxFilesControllerTest < ActionController::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/controllers/dropbox_files_controller_spec.rb — controller spec with shared auth/Pundit contexts"
  end
end
