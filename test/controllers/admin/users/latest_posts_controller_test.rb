...
# Original spec: spec/controllers/admin/users/latest_posts_controller_spec.rb (deleted in this commit; see git history)
...
class Admin::Users::LatestPostsControllerTest < ActionController::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/controllers/admin/users/latest_posts_controller_spec.rb — controller spec with shared auth/Pundit contexts"
  end
end
