...
# TODO: Migrate from RSpec. 66 FactoryBot refs. Original: spec/services/exports/purchase_export_service_spec.rb
...
class Exports::PurchaseExportServiceTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/services/exports/purchase_export_service_spec.rb (66 FactoryBot refs)"
  end
end
