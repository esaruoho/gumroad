...
# TODO: Migrate from RSpec. 37 FactoryBot refs. Original: spec/services/subscription/updater_service_spec.rb
...
class Subscription::UpdaterServiceTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/services/subscription/updater_service_spec.rb (37 FactoryBot refs)"
  end
end
