...
# TODO: Migrate from RSpec. 15 FactoryBot refs. Original: spec/services/subscription/restart_at_checkout_service_spec.rb
...
class Subscription::RestartAtCheckoutServiceTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/services/subscription/restart_at_checkout_service_spec.rb (15 FactoryBot refs)"
  end
end
