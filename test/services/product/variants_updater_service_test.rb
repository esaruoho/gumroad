...
# TODO: Migrate from RSpec. 20 FactoryBot refs. Original: spec/services/product/variants_updater_service_spec.rb
...
class Product::VariantsUpdaterServiceTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/services/product/variants_updater_service_spec.rb (20 FactoryBot refs)"
  end
end
