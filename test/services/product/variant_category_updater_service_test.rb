...
# TODO: Migrate from RSpec. 16 FactoryBot refs. Original: spec/services/product/variant_category_updater_service_spec.rb
...
class Product::VariantCategoryUpdaterServiceTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/services/product/variant_category_updater_service_spec.rb (16 FactoryBot refs)"
  end
end
