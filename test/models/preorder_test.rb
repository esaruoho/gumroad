...
# fixtures-only migration because it has 75 FactoryBot/create references —
...
#
# Original spec: spec/models/preorder_spec.rb (deleted in this commit; see git history)
class PreorderTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/preorder_spec.rb (75 FactoryBot refs) — see comment above"
  end
end
