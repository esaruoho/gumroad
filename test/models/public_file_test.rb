...
# chains (25 refs) that don't transplant cleanly to flat YAML fixtures.
# Revisit post-deadline with a manual rewrite using fixtures.
#
# Original spec: spec/models/public_file_spec.rb (deleted in this commit; see git history)
class PublicFileTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/public_file_spec.rb (25 FactoryBot refs) — see comment above"
  end
end
