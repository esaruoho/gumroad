...
#
# Original spec: spec/models/credit_spec.rb (deleted in this commit; see git history)
class CreditTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/credit_spec.rb (44 FactoryBot refs) — see comment above"
  end
end
