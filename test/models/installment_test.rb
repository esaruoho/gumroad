...
# fixtures-only migration because it has 169 FactoryBot/create references —
...
#
# Original spec: spec/models/installment_spec.rb (deleted in this commit; see git history)
class InstallmentTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/installment_spec.rb (169 FactoryBot refs) — see comment above"
  end
end
