...
# fixtures-only migration because it has 181 FactoryBot/create references —
...
#
# Original spec: spec/models/offer_code_spec.rb (deleted in this commit; see git history)
class OfferCodeTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/offer_code_spec.rb (181 FactoryBot refs) — see comment above"
  end
end
