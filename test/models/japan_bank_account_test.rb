...
#
# Original spec: spec/models/japan_bank_account_spec.rb (deleted in this commit; see git history)
class JapanBankAccountTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/japan_bank_account_spec.rb (41 FactoryBot refs) — see comment above"
  end
end
