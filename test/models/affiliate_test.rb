...
# fixtures-only migration because it has 54 FactoryBot/create references —
...
#
# Original spec: spec/models/affiliate_spec.rb (deleted in this commit; see git history)
class AffiliateTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/affiliate_spec.rb (54 FactoryBot refs) — see comment above"
  end
end
