...
#
# Original spec: spec/models/affiliate_request_spec.rb (deleted in this commit; see git history)
class AffiliateRequestTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/affiliate_request_spec.rb (53 FactoryBot refs) — see comment above"
  end
end
