...
#
# Original spec: spec/models/payment_spec.rb (deleted in this commit; see git history)
class PaymentTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/payment_spec.rb (97 FactoryBot refs) — see comment above"
  end
end
