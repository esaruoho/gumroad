...
# fixtures-only migration because it has 83 FactoryBot/create references —
...
#
# Original spec: spec/models/direct_affiliate_spec.rb (deleted in this commit; see git history)
class DirectAffiliateTest < ActiveSupport::TestCase
  test "TODO: migrate from RSpec — fixture-hostile, requires manual rewrite" do
    skip "TODO: migrate spec/models/direct_affiliate_spec.rb (83 FactoryBot refs) — see comment above"
  end
end
