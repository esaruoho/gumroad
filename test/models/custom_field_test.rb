...
class CustomFieldTest < ActiveSupport::TestCase
  ...
  test "disallows boolean fields for post-purchase custom fields" do
    field = CustomField.new(
      ...
      field_type: CustomField::TYPE_CHECKBOX,
    )
    ...
    assert field.valid?, field.errors.full_messages.to_sentence
  end

  test "sets the default name for file fields" do
    file_field = make_field(field_type: CustomField::TYPE_FILE, name: nil)
  ...
  test "raises an error when name is nil for non-file fields" do
    assert_raises(ActiveRecord::RecordInvalid) do
      make_field(field_type: CustomField::TYPE_TEXT, name: nil)
    end
  end
end
