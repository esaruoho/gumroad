  ...
  before do
    ...
    @default_params = lambda do |purchase|
...

      {
        ...
        settlement_amount_cents: purchase.total_transaction_cents,
        buyer_currency: purchase.buyer_currency,
        buyer_currency_amount_cents: purchase.buyer_currency_amount_cents,
        buyer_currency_exchange_rate: purchase.buyer_currency_exchange_rate,
